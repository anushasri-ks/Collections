...
public class DaffodilsFlowerTester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query = "INSERT INTO flower_table VALUES (8,'Daffodils','light yellow',60,false,'decoration','nosmell','Decorate purpose',20,4)";
